...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { name: @gift.name, receiver_id: @gift.receiver_id, score_cost: @gift.score_cost, sender_id: @gift.sender_id, transaction_id: @gift.transaction_id, url: @gift.url }
    end
  ...
  test "should update gift" do
    put :update, id: @gift, gift: { name: @gift.name, receiver_id: @gift.receiver_id, score_cost: @gift.score_cost, sender_id: @gift.sender_id, transaction_id: @gift.transaction_id, url: @gift.url }
    assert_redirected_to gift_path(assigns(:gift))
  end
